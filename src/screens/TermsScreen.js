  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.card}>
        ...
        <Text style={styles.para}>Welcome to BalanceBook. These Terms of Service govern your access to and use of our financial management and ledger services...</Text>
        <Text style={styles.subtitle}>1. Introduction</Text>
        <Text style={styles.para}>BalanceBook provides a digital platform for merchants to track financial transactions, debts, and credits.</Text>
